	...
	if (req.body.username && req.body.password) {
		...
		if (user) {
			...
			const antdPayload = {
				...
				accessToken: token,
				userInfo: {
					name: 'Spencer Phillips',
					avatar:
						'https://pbs.twimg.com/profile_images/1433865665421746196/ykR5GXxY_400x400.jpg',
					userid: '00000001',
					email: 'spencer@reviveweb.co',
					signature: '',
					title: 'Owner/Developer',
					group: 'Revive Web - Owner',
					tags: [
						{
							key: '0',
							label: '',
					...
					geographic: {
						province: {
							label: 'Ohio',
							key: '17000', // In order of statehood, state # followed by 000 reference: https://www.senclewises.com/statehood.html
						},
						city: {
							label: 'Cuyahoga Falls',
							key: '16000', // In order of inhabitants, city # in order from 1st to last followed by 000 reference: https://www.citydirectory.us/state-ohio.html
						},
					},
					address: '630 Prior Park Drive',
					phone: '1330-391-1069',
				},
			};
			...
			if (user) {
				...
				if (tokenValid) {
					...
					await sendPasswordResetSuccessfulEmail(
						user.email,
						'Evolve Password reset successful'
					);
					return res
						.status(200)
